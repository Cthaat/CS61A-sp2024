...
class Account:
    ...
    def withdraw(self, amount):
        ...
        if amount > self.balance:
            self.transactions.append(Transaction(len(self.transactions), self amount, self.balance))
            return 'Insufficient funds'
        self.balance = self.balance - amount
        self.transactions.append(Transaction(len(self.transactions), amount, self.balance))
        return self.balance
