...
class ThrowerAnt(Ant):
    ...
    def nearest_bee(self):
        ...
        flag = self.place
        num = 0
        while flag is not None and flag.is_hive == False:
...
class QueenAnt(ThrowerAnt):
    ...
    def action(self, gamestate):
        ...
        super().action(gamestate)
        flag = self.place
        while flag.exit is not None:
            flag = flag.exit
            if flag.ant is not None:
                if flag.ant.is_container and flag.ant.ant_contained is not None and not flag.ant.ant_contained.is_doubled:
                    flag.ant.ant_contained.double()
                elif not flag.ant.is_doubled:
                    flag.ant.double()
        # END Problem 12
...
class Bee(Insect):
    ...
    def blocked(self):
        ...
        # BEGIN Problem Optional 1
        if self.place.ant is not None and isinstance(self.place.ant, NinjaAnt):
        # END Problem Optional 1
